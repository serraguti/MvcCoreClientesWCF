...
namespace ReferenceNumberConversion
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="ReferenceNumberConversion.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToWordsResponse> NumberToWordsAsync(ReferenceNumberConversion.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToDollarsResponse> NumberToDollarsAsync(ReferenceNumberConversion.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public ReferenceNumberConversion.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(ReferenceNumberConversion.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public ReferenceNumberConversion.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(ReferenceNumberConversion.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public ReferenceNumberConversion.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(ReferenceNumberConversion.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public ReferenceNumberConversion.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(ReferenceNumberConversion.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface NumberConversionSoapTypeChannel : ReferenceNumberConversion.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<ReferenceNumberConversion.NumberConversionSoapType>, ReferenceNumberConversion.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToWordsResponse> ReferenceNumberConversion.NumberConversionSoapType.NumberToWordsAsync(ReferenceNumberConversion.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            ReferenceNumberConversion.NumberToWordsRequest inValue = new ReferenceNumberConversion.NumberToWordsRequest();
            inValue.Body = new ReferenceNumberConversion.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((ReferenceNumberConversion.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToDollarsResponse> ReferenceNumberConversion.NumberConversionSoapType.NumberToDollarsAsync(ReferenceNumberConversion.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReferenceNumberConversion.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            ReferenceNumberConversion.NumberToDollarsRequest inValue = new ReferenceNumberConversion.NumberToDollarsRequest();
            inValue.Body = new ReferenceNumberConversion.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((ReferenceNumberConversion.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
